...
//!验证信息字段
    char*  section;         //码段
    char*  expiration;      //失效日期    YYYY-MM-DD
    char*  authority;       //权限       ’1‘生成权限  ’2‘ 识别权限 ’3‘通用 =  生成 + 识别



//!附加信息字段
    char*  id;               //编号       例如”232134234“ 正整数
    char*  org_id;           //机构编号    例如”1123123123“ 正整数
    char*  sect_src;         //码段来源    例如 ”智声E联“
    char*  genr_time;        //生成时间 YYYY-MM-DD hh:mm:ss
    char*  genr_type;        //生成方式 '1' 网站获取 ‘2’ 接口获取(API)
