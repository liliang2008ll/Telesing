...
import net.telesing.acs.view.ClearEditText;
...
public class SettingUI extends BaseUI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences(Cookie.COOKIENAME, Context.MODE_PRIVATE);
        cookie = new Cookie(sharedPreferences);
        initWidget();
    }
    ...
    public void initDatabase(){
        ...
        sfeqEdt.setText(String.valueOf(cookie.getfeq(Cookie.DEM_SFEQ,16)[0]));
        efeqEdt.setText(String.valueOf(cookie.getfeq(Cookie.DEM_EFEQ,20)[0]));
    ...
    private void settingParam(){
        ...
        if(CommUtils.isNull(fwq) && CommUtils.isNull(byfwq) && CommUtils.isNull(xhcd) && CommUtils.isNull(xhqz) && CommUtils.isNull(tbjg) && CommUtils.isNull(hcsj)&& CommUtils.isNull(sfeq)&& CommUtils.isNull(efeq)){
            ...
            cookie.putString(Cookie.DEM_SFEQ,sfeq);
            cookie.putString(Cookie.DEM_EFEQ, efeq);
            isSave = true;
