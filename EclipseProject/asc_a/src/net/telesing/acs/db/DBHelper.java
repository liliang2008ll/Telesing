...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS svec"
                + "(id INTEGER PRIMARY KEY AUTOINCREMENT,dates VARCHAR(20),resTag INTEGER,file_path VARCHAR(200),wav_path VARCHAR(200),total_time VARCHAR(20),result VARCHAR(200) )");
        db.execSQL("CREATE TABLE IF NOT EXISTS sn_msg"
                + "(id INTEGER PRIMARY KEY AUTOINCREMENT,sn VARCHAR(20),msg VARCHAR(500) )");
        db.execSQL("CREATE TABLE IF NOT EXISTS sn_list"
                + "(id INTEGER PRIMARY KEY AUTOINCREMENT,sn VARCHAR(20))");
