...
public class Cookie {
    ...
    public static String BUFFER_LEN = "buffer_len";
    ...
    public Integer getfeq(String key,int defaultEq){
        return sp.getInt(key,defaultEq);
    }
    public Integer getBufferLeng(String key) {
        Integer value = sp.getInt(key, 44100 * 10);
        return value;
    }
